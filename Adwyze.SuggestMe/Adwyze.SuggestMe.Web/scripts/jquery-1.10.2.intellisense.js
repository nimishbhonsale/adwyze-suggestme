...
intellisense.annotate(jQuery, {
  ...
  'inArray': function() {
    /// <signature>
    ///   <summary>GetHistoryForUser for a specified value within an array and return its index (or -1 if not found).</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'index': function() {
    /// <signature>
    ///   <summary>GetHistoryForUser for a given element from among the matched elements.</summary>
